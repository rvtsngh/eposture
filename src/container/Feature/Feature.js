                ...
                <div className="container">
                    <div className="feature_layout">
                        <div className="" style={{ paddingTop: "10rem" }}>
                            <div className="pBox feature_center">
                                <div className="feature_box fFirst">
                                    <div className="feature_list mx-5 mb-4" style={{ marginTop: "6rem" }}>
                                        <div className="row">
                                            <div className="col-md-3 feature_list_left">
                                                <img className="img-fluid " style={{ width: "30%" }} src="/images/feature1.png" alt="Feature Image 1" />
                                            </div>
                                            <div className="col-md-9 feature_list_right pt-3 ">
                                                <p className="feature_list_text">画像分析・アンケートから結果をフィードバック</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="feature_list mx-5 mb-4">
                                        <div className="row">
                                            <div className="col-md-3 feature_list_left">
